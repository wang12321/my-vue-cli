            ...
            inquirer.prompt([{
                ...
                async function File(){
                    ...
                    async function settingFile(){
                        ...
                        await fscreateWriteStream(`${resolve('./')}/${desc}/src`,'settings.js',setting.substring(0,setting.indexOf('isSwitchEnvironment')) +`
                      ...
                      ${setting.substring(setting.indexOf('isSwitchEnvironment'),setting.length)}`
                        ...
                        await fscreateWriteStream(`${resolve('./')}/${desc}/src/store/modules`,'settings.js',settings.substring(0,settings.indexOf('isSwitchEnvironment')) +`
